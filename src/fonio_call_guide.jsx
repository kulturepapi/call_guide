...
const styles = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .main-content { flex: 1; overflow-y: auto; padding: 16px; scrollbar-width: thin; scrollbar-color: var(--surface-2) transparent; }
...
const TOTAL = 1800; // 30 mins (Außerhalb des Components, damit Vercel nicht meckert)
