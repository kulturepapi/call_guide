...
const styles = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* NEU: Flex-Container für die gesamte App, damit das Scrollen in der Mitte funktioniert */
  ...
  /* Der Container, der jetzt den restlichen Platz füllt und scrollbar ist */
  ...
  .gate-title { font-size: 12px; font-weight: 600; color: var(--amber); margin-bottom: 8px; display: flex;
